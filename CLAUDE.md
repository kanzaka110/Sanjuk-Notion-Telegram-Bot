...
- **Stock_bot/** — 산적주식비서 코드 (notion-stock-update에서 통합, Notion 주가 업데이트 + AI 브리핑)
- **UE_bot/** — UE5 가이드 비서 코드 (desktop-tutorial에서 통합, UE 애니메이션 브리핑 + 챗봇)
- **GameNews_bot/** — 게임뉴스 봇 코드 (desktop-tutorial에서 통합, 게임뉴스 수집 + 챗봇)
