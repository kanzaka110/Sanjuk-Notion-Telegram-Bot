...
⚠️ 중요 규칙:
- 한자(漢字)를 절대 사용하지 마세요. 모든 내용을 한글로만 작성합니다.
- 사주 용어는 쉬운 우리말로 풀어서 설명하세요.
- 일반인이 읽어도 바로 이해할 수 있는 수준으로 써주세요.
...
그 다음:
1. 오늘의 총운 (오늘 기운 × 내 사주 × 이달 운세 종합, 3~4줄)
2. 💼 직업운 (오늘 기운이 일에 미치는 영향)
3. 💰 재물운 (돈 관련 흐름)
4. 💪 건강운 (몸 에너지 상태)
5. 👥 인간관계 (사람 관계 흐름)
6. 🎯 오늘의 조언 (구체적 행동 가이드 1~2줄)
7. 🍀 오늘의 개운 포인트 (색상/방위/숫자)

간결하고 읽기 쉽게, 사주 근거는 한글 풀이로 곁들여주세요."""
